...
export default function AutomationLab() {
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-5 md:p-6" aria-labelledby="config-management-title"><SectionTitle icon={GitBranch} title={t.config} id="config-management-title" /><div className="mt-4 overflow-x-auto"><table className="w-full min-w-[850px] text-left text-xs"><thead><tr className="border-b border-slate-200 text-slate-500"><th className="p-3">Tool</th><th className="p-3">{t.property}</th><th className="p-3">{t.representation}</th><th className="p-3">{t.distinction}</th></tr></thead><tbody>{CONFIG_MANAGEMENT.map(row => <tr key={row.tool} className="border-b border-slate-100 align-top"><th className="p-3 font-semibold text-indigo-700">{row.tool}</th><td className="p-3 text-slate-600">{row.model[language]}</td><td className="p-3 text-slate-600">{row.data[language]}</td><td className="p-3 leading-relaxed text-slate-600">{row.distinction[language]}</td></tr>)}</tbody></table></div></section>
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-5 md:p-6" aria-labelledby="automation-security-title"><SectionTitle icon={ShieldCheck} title={t.security} id="automation-security-title" /><div className="mt-4 overflow-x-auto"><table className="w-full min-w-[980px] text-left text-xs"><thead><tr className="border-b border-slate-200 text-slate-500"><th className="p-3">{t.threat}</th><th className="p-3">{t.impact}</th><th className="p-3">{t.defense}</th></tr></thead><tbody>{SECURITY_ROWS.map(row => <tr key={row.threat.en} className="border-b border-slate-100 align-top"><th className="p-3 font-semibold text-rose-700">{row.threat[language]}</th><td className="p-3 leading-relaxed text-slate-600">{row.impact[language]}</td><td className="p-3 leading-relaxed text-emerald-800">{row.defense[language]}</td></tr>)}</tbody></table></div></section>
