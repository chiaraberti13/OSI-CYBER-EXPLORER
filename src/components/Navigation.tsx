import { Activity, BookOpen, Cable, Calculator, FileCode2, FileSearch, GitBranch, Hash, Layers, LockKeyhole, Map, Route, ServerCog, Shield, Swords, Workflow } from 'lucide-react';
