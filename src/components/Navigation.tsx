import { Activity, BookOpen, Cable, Calculator, FileCode2, FileSearch, GitBranch, Hash, HeartPulse, Layers, LockKeyhole, Map, Network, Radar, Route, ServerCog, Shield, Swords, Workflow } from 'lucide-react';
