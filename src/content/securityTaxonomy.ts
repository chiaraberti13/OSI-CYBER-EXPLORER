...
export const ATTACK_FAMILIES: AttackFamily[] = [
  ...
  { id: 'availability', name: { it: 'DoS, DDoS ed esaurimento risorse', en: 'DoS, DDoS, and resource exhaustion' }, description: { it: 'Riduzione o interruzione della disponibilità di collegamenti, dispositivi o servizi.', en: 'Degradation or interruption of the availability of links, devices, or services.' }, planes: ['physical', 'data', 'control', 'application'] },
