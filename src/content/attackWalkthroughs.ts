...
export const ATTACK_WALKTHROUGHS: AttackWalkthrough[] = [
  ...
  },
  {
    ...
    steps: [
      { actor: 'attacker', title: { en: 'Forge gratuitous ARP replies', it: 'Falsifica risposte ARP gratuite' }, detail: { en: 'The attacker tells the victim "the gateway IP is at my MAC address", and tells the gateway the same about the victim: both ARP caches end up poisoned, which is what puts the attacker in the middle of the conversation.', it: 'L\'attaccante dichiara alla vittima "l\'IP del gateway è al mio indirizzo MAC", e dichiara al gateway la stessa cosa sulla vittima: entrambe le cache ARP restano avvelenate, ed è questo che mette l\'attaccante in mezzo alla conversazione.' }, packet: 'ARP reply: 192.168.1.1 is-at AA:AA:AA' },
