...
interface AppState {
  ...
  activeView: 'curriculum' | 'fundamentals' | 'osi' | 'attacklab' | 'ports' | 'security' | 'glossary';
  setActiveView: (view: 'curriculum' | 'fundamentals' | 'osi' | 'attacklab' | 'ports' | 'security' | 'glossary') => void;
